...
<body>
  ...
  <div class="wrapper">
      ...
      <ul>
        <li><a href="index.php">
          ...
          <li><a href="ResourcesGlobal.php">Global</a></li>
            ...
            <li><a href="ResourcesCategories.php" class="active">Catégories</a></li>
          </ul>
        ...
        <li><a href="ActivitiesCategories.php">Catégories</a></li>
        </ul>
      </ul>
    </div>
    ...
    <div class="main_container">
      <div class="searsh">
      <form action="ResultACT.php" method="post">
        <select id="select-prof" name="catName" placeholder="Pick a prof">
