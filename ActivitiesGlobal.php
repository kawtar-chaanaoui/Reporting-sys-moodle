...
$dataPoints = [];
foreach($t as $var)
 {  $val= getQuizNmbrByCategoryName($var)
         +getWorkshopNmbrByCategoryName($var)
         +getAssignmentNmbrByCategoryName($var);
    $Cname= $var;
   ...
   <div class="top_navbar">
    ...
    <div class="sidebar">
      <ul>
        ...
        <li><a href="ActivitiesGlobal.php"  class="active">Global</a></li>
